...
| Platform | Download |
|----------|----------|
| Windows | `OpenTimeSync_2.1.11_x64_en-US.msi` / `OpenTimeSync_2.1.11_x64-setup.exe` |
| macOS | `OpenTimeSync_2.1.11_x64.dmg` / `OpenTimeSync_2.1.11_aarch64.dmg` |
| Linux | `OpenTimeSync_2.1.11_amd64.deb` / `OpenTimeSync_2.1.11_amd64.AppImage` |
