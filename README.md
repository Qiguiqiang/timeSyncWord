...
| Platform | Download |
|----------|----------|
| Windows | `OpenTimeSync_2.1.4_x64_en-US.msi` / `OpenTimeSync_2.1.4_x64-setup.exe` |
| macOS | `OpenTimeSync_2.1.4_x64.dmg` / `OpenTimeSync_2.1.4_aarch64.dmg` |
| Linux | `OpenTimeSync_2.1.4_amd64.deb` / `OpenTimeSync_2.1.4_amd64.AppImage` |
